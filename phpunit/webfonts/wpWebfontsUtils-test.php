...
class Tests_Webfonts_WpWebfontsUtils extends WP_Webfonts_TestCase {
	 ...
	 */
	public function tests_convert_variation_into_handle_with_invalid_variation( $font_family, $invalid_variation ) {
		$this->assertNull( WP_Webfonts_Utils::convert_font_family_into_handle( $invalid_variation ) );
	}
	 ...
	 *
	 * @expectedIncorrectUsage WP_Webfonts_Utils::get_font_family_from_variation
	 *
	 * @param array $invalid_variation Variation to test.
	 */
	public function test_get_font_family_from_variation_with_invalid_input( array $invalid_variation ) {
